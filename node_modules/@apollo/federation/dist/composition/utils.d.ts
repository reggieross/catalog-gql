...
import { ObjectTypeDefinitionNode, InterfaceTypeExtensionNode, FieldDefinitionNode, StringValueNode, NameNode, DocumentNode, ObjectTypeExtensionNode, DirectiveNode, GraphQLNamedType, GraphQLError, GraphQLSchema, GraphQLObjectType, GraphQLField, SelectionNode } from 'graphql';
...
export declare function findDirectivesOnTypeOrField(node: Maybe<ObjectTypeDefinitionNode | ObjectTypeExtensionNode | FieldDefinitionNode | InterfaceTypeExtensionNode>, directiveName: string): DirectiveNode[];
