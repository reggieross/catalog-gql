...
class TypeScriptResolversVisitor extends visitor_plugin_common_1.BaseResolversVisitor {
    constructor(pluginConfig, schema) {
        super(pluginConfig, {
            avoidOptionals: visitor_plugin_common_1.getConfigValue(pluginConfig.avoidOptionals, false),
            immutableTypes: visitor_plugin_common_1.getConfigValue(pluginConfig.immutableTypes, false),
            useIndexSignature: visitor_plugin_common_1.getConfigValue(pluginConfig.useIndexSignature, false),
        }, schema);
        autoBind(this);
