...
export declare class SelectionSetToObject {
    ...
    constructor(_scalars: ScalarsMap, _schema: GraphQLSchema, _convertName: ConvertNameFn<BaseVisitorConvertOptions>, _addTypename: boolean, _preResolveTypes: boolean, _nonOptionalTypename: boolean, _loadedFragments: LoadedFragment[], _namespacedImportName: string | null, _dedupeOperationSuffix: boolean, _enumPrefix: boolean, _parentSchemaType?: GraphQLNamedType, _selectionSet?: SelectionSetNode);
