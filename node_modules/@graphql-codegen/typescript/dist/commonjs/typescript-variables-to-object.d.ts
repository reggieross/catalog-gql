...
export declare class TypeScriptOperationVariablesToObject extends OperationVariablesToObject {
    ...
    constructor(_scalars: ScalarsMap, _convertName: ConvertNameFn, _avoidOptionals: boolean, _immutableTypes: boolean, _namespacedImportName?: string | null, _enumNames?: string[], _enumPrefix?: boolean);
